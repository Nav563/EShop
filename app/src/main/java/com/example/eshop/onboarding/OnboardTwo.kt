...
import com.example.eshop.navigation.OnBoard3
import com.example.eshop.ui.theme.Background

@Composable
fun OnboardTwoScreen(navHostController: NavHostController) {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .fillMaxWidth()
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.nike_prev_ui),
                    contentDescription = "",
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                Image(
                    painter = painterResource(id = R.drawable.ellipse_907), contentDescription = "",
                    modifier = Modifier
                        .size(140.dp)
            ...
            Text(
                text = stringResource(id = R.string.onboard_two_title),
            ...
            Text(
                text = stringResource(id = R.string.onboard_two_subtitle),
            ...
            NavigationRow2(onClick = {
                navHostController.navigate(OnBoard3)
            })
        }
    }
}
...
@Composable
fun NavigationRow2(onClick: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = 60.dp),
