    ...
    Box(
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.digital_sketches_prev_ui),
                    contentDescription = "",
                    modifier = Modifier
                        .fillMaxWidth()
            ...
            Text(
                text = stringResource(id = R.string.onboard_one_title),
                fontSize = 40.sp, fontWeight = W500,
                fontStyle = FontStyle.Italic,
                modifier = Modifier
                    .padding(top = 20.dp)
            )
            Text(
                text = stringResource(id = R.string.onboard_one_subtitle),
                fontSize = 20.sp, fontWeight = W400,
                fontFamily = FontFamily.Cursive,
                color = colorResource(id = R.color.subtitle_color),
                modifier = Modifier
                    .padding(top = 10.dp)
            )
            NavigationRow(onClick = {
                navHostController.navigate(OnBoard2)
            })
...
@Composable
fun NavigationRow(onClick : () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = 130.dp),
